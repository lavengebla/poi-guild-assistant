package ru.ed.views.participants;
...
import ru.ed.data.SamplePerson;
import ru.ed.services.SamplePersonService;
...
public class ParticipantsView extends Div {
    ...
    public ParticipantsView(SamplePersonService SamplePersonService) {
